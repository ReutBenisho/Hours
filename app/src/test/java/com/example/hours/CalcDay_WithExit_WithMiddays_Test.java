...
public void test1_Arrival_08_09_Exit_16_46_Arrival_19_15_Exit_19_51_Arrival_20_40_Exit_21_23() {
        ...
        mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 9);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 46, 19, 15));
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(19, 51, 20, 40));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(21, 23);
...
public void test2_Arrival_8_44_Exit_16_48_Arrival_19_15_Exit_20_13() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 44);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 48, 19, 15));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 13);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
    ...
    public void test_ignored_3_Arrival_8_16_Exit_13_41_Arrival_15_55_Exit_20_11() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 16);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(13, 41, 15, 55));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 11);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test4_Arrival_7_52_Exit_16_49_Arrival_19_40_Exit_20_49() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(7, 52);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 49, 19, 40));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 49);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test5_Arrival_8_7_Exit_16_46_Arrival_19_15_Exit_19_51() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 7);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 46, 19, 15));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(19, 51);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test6_Arrival_8_23_Exit_16_48_Arrival_19_15_Exit_20_09() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 23);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 48, 19, 15));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 9);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
    ...
    public void test_ignored_7_Arrival_8_3_Exit_12_49_Arrival_19_26_Exit_21_38() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 3);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(12, 49, 19, 26));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(21, 38);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test8_Arrival_8_30_Exit_16_48_Arrival_19_15_Exit_21_38() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 30);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 48,19,15));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 28);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
    ...
    public void test_ignored_9_Arrival_8_12_Exit_17_16_Arrival_18_8_Exit_21_44() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 12);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(17, 16, 18, 8));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(21, 44);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test10_Arrival_8_44_Exit_13_29_Arrival_15_34_Exit_18_47() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime.setTime(8, 44);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(13, 29, 15, 34));
       mHoursManager.mInfo.userInfo.exitTime.setTime(18, 47);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
    ...
    public void test_ignored_11_Arrival_8_38_Exit_12_35_Arrival_14_15_Exit_21_24() {
       ...
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(12, 35, 14, 15));
...
public void test12_Arrival_7_40_Exit_12_41_Arrival_15_45_Exit_17_31() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(7, 40);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(12, 41, 15, 45));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(17, 31);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test13_Arrival_8_33_Exit_13_29_Arrival_14_12_Exit_18_39() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 33);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(13, 29, 14, 12));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(18, 39);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
    ...
    public void test_ignored_14_Arrival_8_18_Exit_11_15_Arrival_11_50_Exit_19_48() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 18);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(11, 15, 11, 50));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(19, 48);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test15_Arrival_7_38_Exit_13_35_Arrival_13_54_Exit_16_38() {
       ...
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(16, 38);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test16_Arrival_9_49_Exit_13_0_Arrival_18_13_Exit_21_39() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(9, 49);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(13, 0, 18, 13));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(21, 39);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test17_Arrival_7_32_Exit_14_56_Arrival_19_0_Exit_20_59() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(7, 32);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(14, 56, 19, 0));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 59);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test18_Arrival_8_40_Exit_15_55_Arrival_18_35_Exit_20_10() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 40);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(15, 55, 18, 35));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(20, 10);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test19_Arrival_8_37_Exit_15_55_Arrival_16_34_Exit_19_12() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 37);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(15, 55, 16, 34));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(19, 12);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test20_Arrival_8_54_Exit_16_32_Arrival_20_0_Exit_22_19() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 54);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 32, 20, 0));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(22, 19);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
...
public void test21_Arrival_8_26_Exit_16_36_Arrival_20_37_Exit_22_16() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 26);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(16, 36, 20, 37));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(22, 16);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
    ...
    public void test_ignored_22_Arrival_8_9_Exit_18_6_Arrival_18_32_Exit_19_23_Arrival_19_28_Exit_21_14() {
       ...
       mHoursManager.mInfo.userInfo.arrivalTime = new Timestamp(8, 9);
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(18, 6, 18, 32));
       mHoursManager.mInfo.breaks.customBreaks.add(new Break(19, 23, 19, 28));
       mHoursManager.mInfo.userInfo.exitTime = new Timestamp(21, 14);
        mHoursManager.CalcDayWithExit();
        HoursInfo expHoursInfo = new HoursInfo();
        expHoursInfo.userInfo.arrivalTime = new Timestamp(8, 9);
